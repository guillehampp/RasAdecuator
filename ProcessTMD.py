...
class ProcessTMD(ProcessBase):
    def __init__(self, workspace_path, temporal_parameterFile=None, parameterFile=None, config_params = None,adq_id = None, path_to_adq = None,platform=None):
        super().__init__(workspace_path, temporal_parameterFile, parameterFile, config_params,adq_id, path_to_adq,platform)
    ...
    def adec_xemtmd(self):
        ...
        workdir_tmd = os.path.join(self.path_to_adq, self.config_params.get('workspace_tmd_input'))
        lista_vc0_xemt=[]
